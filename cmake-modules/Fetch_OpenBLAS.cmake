...
if(NOT TB_EIGEN3_BLAS)
    return()
endif()


if(NOT TARGET openblas::openblas AND TB_DOWNLOAD_METHOD MATCHES "find|fetch")
    set(OpenBLAS_FIND_VERBOSE ON)
    find_package(OpenBLAS)
endif()

if(NOT TARGET openblas::openblas AND TB_DOWNLOAD_METHOD MATCHES "fetch")
