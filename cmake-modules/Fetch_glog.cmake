...
if(NOT TARGET glog::glog AND TB_DOWNLOAD_METHOD MATCHES "find|fetch")
    ...
    if(TB_PREFER_CONDA_LIBS AND NOT BUILD_SHARED_LIBS)
...
if(NOT TARGET glog::glog AND TB_DOWNLOAD_METHOD MATCHES "fetch")
