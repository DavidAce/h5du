...
if(NOT TARGET Eigen3::Eigen AND TB_DOWNLOAD_METHOD STREQUAL "find")
    message(STATUS "TB needs a patched version of Eigen 3.3.7 and will downloaded despite TB_DOWNLOAD_METHOD=find")
endif()

if(NOT TARGET Eigen3::Eigen AND TB_DOWNLOAD_METHOD MATCHES "find|fetch")
    # We want to find our own Eigen3 to make sure we patch it properly
    find_package(Eigen3
        HINTS ${CMAKE_INSTALL_PREFIX}
        NO_DEFAULT_PATH) # IMPORTANT TO ONLY LOOK IN TB'S OWN PLACE
