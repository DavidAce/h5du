if(NOT TARGET h5pp::h5pp AND H5DU_DOWNLOAD_METHOD STREQUAL "find")
...
if(NOT TARGET h5pp::h5pp AND H5DU_DOWNLOAD_METHOD MATCHES "fetch")
    find_package(h5pp  1.8.3
...
if(NOT TARGET h5pp::h5pp AND H5DU_DOWNLOAD_METHOD MATCHES "fetch")
    ...
    list(APPEND H5PP_CMAKE_OPTIONS  -DH5PP_DOWNLOAD_METHOD:BOOL=${H5DU_DOWNLOAD_METHOD})
    list(APPEND H5PP_CMAKE_OPTIONS  -DH5PP_PREFER_CONDA_LIBS:BOOL=${H5DU_PREFER_CONDA_LIBS})
