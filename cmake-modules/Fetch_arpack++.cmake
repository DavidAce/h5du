...
if(NOT TARGET arpack::arpack++ AND TB_DOWNLOAD_METHOD STREQUAL "find")
...
if(NOT TARGET arpack::arpack++ AND TB_DOWNLOAD_METHOD MATCHES "find|fetch")
    find_package(arpack++)
    if (TARGET arpack::arpack++)
        message(STATUS "Found arpack++")
    endif()
...
if(NOT TARGET arpack::arpack++ AND TB_DOWNLOAD_METHOD MATCHES "fetch")
    message(STATUS "arpack++ will be installed into ${CMAKE_BINARY_DIR}/tb-deps-install/arpack++ on first build.")
